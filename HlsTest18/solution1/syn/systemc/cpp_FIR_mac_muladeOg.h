...
#ifndef __cpp_FIR_mac_muladeOg__HH__
#define __cpp_FIR_mac_muladeOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cpp_FIR_mac_muladeOg) {
    ...
    SC_CTOR(cpp_FIR_mac_muladeOg):  simcore_mac_0_U ("simcore_mac_0_U") {
