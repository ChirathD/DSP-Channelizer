...
#ifndef __cpp_FIR_mul_mul_6dEe__HH__
#define __cpp_FIR_mul_mul_6dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cpp_FIR_mul_mul_6dEe) {
    ...
    SC_CTOR(cpp_FIR_mul_mul_6dEe):  ACMP_smul_us_U ("ACMP_smul_us_U") {
